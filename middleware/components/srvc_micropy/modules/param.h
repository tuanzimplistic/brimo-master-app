...
**  @date       : 2021 Aug 25
**  @brief      : Exports functions of param MP module for binding into MicroPython
**  @namespace  : MP
**
** * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
*/
...
extern mp_obj_t x_MP_Param_Get_All_Keys (mp_obj_t x_namespace);

/* Erases all parameters in a non-volatile storage namespace */
extern mp_obj_t x_MP_Param_Erase_All (mp_obj_t x_namespace);
